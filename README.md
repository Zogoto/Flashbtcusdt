# Flashbtcusdt
Crypto F Transaction is a software developed by an anonymous FCryptoCoder team, which allows the sending of several crypto currencies (USDT, BTC, ETH, SOL).   
...
SOL: The maximum sending is 10,000 SOL. Sending SOL can be done on the following networks: SOL and BEP20.
...
Lifetime 6000$
Telegram : @cryptozogo
mail: zogocrypto@gmail.com
Site: https://legit-software.com/product/detail/7/crypto-fake-transaction-software-full-version
